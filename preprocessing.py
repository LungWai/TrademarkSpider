...
class SuperPreprocessor(JsonViser, JsonFlattener, JsonLinesToDynamoDBConverter, JsonCleaner):  # Added JsonCleaner as a parent class
    ...
    def preprocess(self):
        ...
        print("Flattened JSON written to", self.output_path)
...
if __name__ == "__main__":
    input_path = 'Datafile\\trademark5.jsonlines'
    output_path = 'Datafile\\getkTM.jsonlines'
    flatten_outpath = 'Datafile\\flattenTM.jsonlines'
    clean_outpath = 'Datafile\\cleanTM.jsonlines'
    dynamodb_outpath = 'Datafile\\dynamodb.json'
